      ...
      <div className="min-h-screen">
        <div className="flex min-h-screen">
          <aside
            ...
            className="z-40 h-screen w-64 -translate-x-full border border-slate-200 transition-transform sm:translate-x-0"
            aria-label="Sidebar"
          >
            <div className="h-full w-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
